...
def main():
    ...
    wt_5,loss_list_5 = gd_optimizer(data=img_combined,target=target_greater_than_5,w_shape=100,initial_variance=1,eta=eta,epochs=epochs)
    print('#'*10 + 'Number is even' + '#'*10)
    wt_ev,loss_list_ev = gd_optimizer(data=img_combined,target=target_even,w_shape=100,initial_variance=1,eta=eta,epochs=epochs)
    print('#'*10 + 'Number is prime' + '#'*10)
    wt_p,loss_list_p = gd_optimizer(data=img_combined,target=target_prime,w_shape=100,initial_variance=1,eta=eta,epochs=epochs)
    ax.plot(loss_list_5)
